...
class Header extends React.Component {
  render() {
    return (
      <section className="lg:ml-32 ml-8 mt-8 lg:flex lg:justify-between grid grid-cols-1 ">
        <figcaption className='flex flex-col justify-center'>
          ...
          <button className="bg-red text-white shadow-xl w-48 text-md h-14 rounded-md hover:bg-white hover:text-black mt-8">
            Shop for books
          </button>
        </figcaption>
        ...
        <figure className="py-6 bg-yellow lg:w-6/12 w-full flex justify-center cursor-pointer mt-8 lg:mt-0 ">
          ...
          <figure>
            <div className="bg-red w-24 h-24 lg:h-36 lg:w-36 rounded-full mt-72 lg:mr-6  relative top-20"></div>
