...
render(){
  ...
  const handleSubmit = (e)=>{
    ...
    .then(()=>{
      alert('Thanks, for taking time to join the book community. We would like you to know that your book has been added to the queue and we would reach out in 72 working days')
      ...
      <main className="">
        <section className="lg:flex lg:justify-between lg:items-center lg:ml-8 ml-2">
          <hgroup className=" lg:w-2/4">
            <h1 className="lg:text-8xl text-6xl font-bold mt-2 lg:mt-0 mb-8">Join Us. </h1>
            ...
            <div className="lg:flex items-center  mt-8">
              ...
              <div className="lg:flex items-center flex mt-8">
              <input
                className="border-2 w-72 h-8 border-black shadow-x rounded-sml"
